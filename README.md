...
> Navigate to the week4 folder containing:  copyExomes.sh, createCrisprReady.sh, identifyCrisprSite.sh, editGenome.sh and python3 exomeReport.py
...
>4. ./editGenome.sh
>5. python3 exomeReport.py


====== EXPECTED INPUTS & OUTPUTS FILES ======
...
> The input .fasta files need a specific layout:
>>* Line1 : “>Gene#”
>>* Line2 : DNA sequence

> The column layout of clinical_data.txt must be idential to the following, each separated with tabs:
>> Discoverer      Location        Diameter (mm)   Environment     Status  code_name

> As long as the layout of the input .fasta files and linical_data.txt is identical, this pipeline will work with any given data. 
